...
namespace InfMan2
{
    class DataFiller
    {
        ...
        {
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Privacy is een afweerrecht dat de persoonlijke levenssfeer beschermt", true, ""));
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Privacy is alleen de verantwoordelijkheid van de gebruiker, niet van de ontwikkelaar", false, ""));
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Een veilige webomgeving herken je aan het hangslotje en aan de adresregel dat begint met https.", true, ""));
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Privacy kan je onder andere beschermen door de voorwaarden van een" + System.Environment.NewLine + " applicatie te lezen die je gaat gebruiken", true, ""));
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Mogen organisaties altijd mijn persoonsgegevens verwerken volgens" + System.Environment.NewLine + " de Wet bescherming persoonsgegevens (Wbp)?", false, ""));
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Organisaties moeten voldoen aan een aantal eisen van de Wet bescherming persoonsgegevens"+ System.Environment.NewLine + " (Wbp) bij het verwekend van persoonsgegevens",true, ""));
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Als een organisatie zich voldoet aan de eisen van de Wet " + System.Environment.NewLine + "bescherming persoonsgegevens (Wbp), betekent dit dat mijn informatie veilig is?", false, ""));
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Persoonsgegevens zijn geven direct of indirect informatie over een persoon", true, ""));
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Bedrijven kunnen geen boete krijgen bij het overtreden van privacy wetten", false, ""));
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Werkgevers mogen medische gegevens opslaan in een personeelsdossier", false, ""));
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Mag een werkgever een internet search doen naar werknemers of sollicitanten?", false, ""));
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Mag een werkgever met als reden ‘’Privé internetten is verboden’’, bijhouden wat zijn werknemers doen op hun PC of via de bedrijfs internetverbinding", false, ""));
            Data.trueFalseQuestionsList.Add(new Tuple<string, bool, string>("Is het plaatsen van een GPS, C-track of Blackbox-systeem in wagens van chauffeurs ivm de planning toegestaan ? ", true, ""));
